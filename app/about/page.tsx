      ...
      <div className="flex-1 p-8">
        ...
        <div className="bg-secondary rounded-lg p-8 max-w-2xl">
          ...
          <p className="text-gray-400 mb-6">
            Belive Jackpot is an hourly lottery for $BELIVE token holders on Solana. Every hour, the top 100 holders are entered into a draw, with tickets proportional to their holdings (1,000 tokens = 1 ticket). The winner receives the entire prize pool, which accumulates from fees in the reward wallet.
          </p>
          ...
          <ul className="text-gray-300 space-y-2 mb-6">
            ...
            <li>• React & TailwindCSS (UI)</li>
            <li>• MongoDB (round history)</li>
            <li>• Solana Tracker API (data source)</li>
          </ul>
          <h3 className="text-lg font-semibold mb-2">Open Source</h3>
          <p className="text-gray-400">
            This project is open source and community-driven. Contributions and feedback are welcome!
          </p>
        </div>
      </div>
    </div>
